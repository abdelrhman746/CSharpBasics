...
namespace NumbersDataTypes
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ushort us1 = 65535;
            //short us2=-32000;//compile-time error: Constant value '-32000' cannot be converted to a 'ushort'
            ...
            //int k=4294967295;//compile-time error: Constant value '4294967295' cannot be converted to a 'int'

            uint ui1 = 4294967295;
            //short us2=-1;//compile-time error: Constant value '-1' cannot be converted to a 'uint'
